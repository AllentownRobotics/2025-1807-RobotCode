...
public class TunerConstants {
    ...
    // auto pid values (should be same as steer and drive gains)
    ...
    public static double maxDriveSpeed = kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts desired top speed

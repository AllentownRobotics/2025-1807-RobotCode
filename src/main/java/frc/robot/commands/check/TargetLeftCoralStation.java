...
public class TargetLeftCoralStation extends Command {
  ...
  public void target(){
    xalignmentValue = vision.getLeftCoralStationalignmentValues()[0];
    zalignmentValue = vision.getLeftCoralStationalignmentValues()[1];
    yawalignmentValue = vision.getLeftCoralStationalignmentValues()[2];
